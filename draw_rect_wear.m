function draw_rect_wear() %use PCA_3D to compute RGB(correct) ; don't sort the bins ; use LAP_1D for position x
    k = 25;     
    file_name = '20140911_0000_2_refine';
    folder_name = strcat(file_name,'_lacc');
    ...
    %transMatrix = PCA_1D_2(histo_mat);
